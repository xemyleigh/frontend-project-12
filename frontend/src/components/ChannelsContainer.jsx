...
const Channel = ({ value, isCurrent, id, removable }) => {
    ...
    const renameChannelHandler = (id, body) => () => {
    ...
    return (
        <li className='nav-item w-100 '>
            <div className='d-flex'>
                <button className={`w-100 rounded text-start btn ${(isCurrent) ? 'bg-secondary' : null}`} onClick={channelHandler(id)}>
                ...
                {removable && (
                    <>                
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" onClick={removeChannelHandler(id)}>Удалить</a></li>
